...
import 'package:pixi_vpn/ui/shared/location/v2_location_screen.dart';
import 'package:pixi_vpn/ui/shared/setting/live_chat_screen.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:pixi_vpn/utils/link_launcher.dart';
import 'package:pixi_vpn/platform/android/vpn_service.dart';
...
// State variables
  ...
  // Android VPN service (initialized in initState)
  late AndroidVpnService vpnService;
                                  ...
                                  try {
                                    ...
                                    if (value.state == 'CONNECTED') {
                                      ...
                                      Future<void> performV2Connect() async {
                                        if (await vpnService.requestPermission()) {
                                          vpnService.start(
